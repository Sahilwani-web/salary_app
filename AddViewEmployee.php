...
<body>
    ...
    <body>
        ...
        <div class="container">
            <div class="content">
                <a href="../salary_management/users/user.php">
        ...
        <button id ="deletedata" class = "btn btn-danger"><a href="delete.php?deleteid=' . $employeeid . '" class ="text-light">Delete</a></button>
    </td>
    ...
    function deleteUser(employeeid) {
        ...
        if (userConfirmation === 'DELETE') {
            // Send an AJAX request or submit a form to delete the user with the specified ID
            ...
            alert('Deletion canceled. Type "DELETE" to confirm deletion.');
        }
    }
</script>
